...
_$ReceiptImpl _$$ReceiptImplFromJson(Map<String, dynamic> json) =>
    _$ReceiptImpl(
      ...
      ocrResults: json['ocrResults'] == null
          ? null
          : ProcessingResult.fromJson(
              json['ocrResults'] as Map<String, dynamic>),
...
_$ProcessingResultImpl _$$ProcessingResultImplFromJson(
    ...
    _$ProcessingResultImpl(
      ...
      totalAmount:
          DoubleFieldData.fromJson(json['totalAmount'] as Map<String, dynamic>),
      date: DateFieldData.fromJson(json['date'] as Map<String, dynamic>),
      taxAmount:
          DoubleFieldData.fromJson(json['taxAmount'] as Map<String, dynamic>),
